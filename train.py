...
def main():
    ...
    with open('/home/mattd/pycharm/encoder/model_outputs_3/attention',
              'w') as outfile:
        ...
        train_loss, val_loss = load_checkpoint(
        ...
        for epoch in range(last_epoch, last_epoch+nb_epochs):
            ...
            for phase, data_loader in zip(phases, data_loaders):
                ...
                if epoch_loss < lowest_loss and phase == 'val':
                    save_checkpoint(model, loss, optimizer, model_filename,
                                    description_filename, epoch)
